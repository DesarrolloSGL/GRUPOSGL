<div id="home_mg_base_div" class="home_quoters_base">
            ...
            <div id="home_mg_package_div" class="home_quoters_base hidden bg-white border rounded-b-lg w-11/12 mx-auto h-fit shadow-xl
                ...
                <div class="lg:grid lg:gap-8 lg:grid-cols-2">
                    <div>
                        <div class="text-center py-3 mx-auto w-fit">
                            ...
                            <select id="home_mg_service_select" name="service" class="py-1 px-2 rounded-lg h-10 border-none bg-gray-100
                                text-gray-500 text-sm">
                                <option class="" value="1" selected>P.O. BOX</option>
                            </select>
                        </div>
                        <div class="text-center p-1 relative hidden">
                            <input id="home_mg_link" name="link" class=" left-28 bottom-7 home_quotation_keyup h-10 rounded-lg border-none bg-gray-100" type="text" placeholder="Pasame Tu Link">
                        </div>

                        <div class="grid grid-cols-1 lg:grid-cols-1">
                            <div class="text-center">
                                <h3 class="text-sm font-bold">Valor de mercadería en US$:</h3>
                                <input id="home_mg_price" name="price" class="home_quotation_keyup w-11/12 sm:w-8/12 lg:w-11/12 xl:w-auto rounded-lg h-10 border-none bg-gray-100" type="text" placeholder="Precio">
                            </div>
                            <div class="text-center">
                                <h3 class="text-sm font-bold">Shipping en US$:</h3>
                                <input id="home_mg_shipping" name="shipping" class="home_quotation_keyup w-11/12 sm:w-8/12 lg:w-11/12 xl:w-auto rounded-lg h-10 border-none bg-gray-100" type="text" placeholder="Shipping">
                            </div>
                            <div class="text-center">
                                <h3 class="text-sm font-bold">Peso en libras: </h3>
                                <input id="home_mg_weight" name="weight" class="home_quotation_keyup w-11/12 sm:w-8/12 lg:w-11/12 xl:w-auto rounded-lg h-10 border-none bg-gray-100 " type="text" placeholder="Peso">
                            </div>
                            <div class="text-center ">
                                <h3 class="text-sm font-bold">Descripción:</h3>
                                <select id="home_mg_description" name="description" class="home_quotation_change max-w-[226px] lg:w-11/12 xl:w-auto rounded-lg h-10 border-none bg-gray-100  text-center text-sm text-gray-500">
                ...
                <div id="home_mg_conditions_order_div" class="home_quoters text-center mt-5 hidden">
                    @auth
                        ...
                        <span data-modal-target="defaultModalMg" data-modal-toggle="defaultModalMg" class="underline text-sm mt-5 sm:mt-0 cursor-pointer hover:text-global-700">
                            VER CONDICIONES DE SERVICIO</span>
                        <button id="home_mg_btn_quotation_order" type="button" class="flex mx-auto mt-5 bg-global-950 px-4 py-2
            ...
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t ">
                    <h3 class="text-xl font-semibold text-gray-900 ">
                        Condiciones de Servicio P.O.BOX y Todo Incluido
                    </h3>
    ...
    {{-- OSC -> Finish --}}
    <div id="home_mg_osc" class="home_quoters_base hidden bg-white border rounded-xl
        mx-auto h-auto w-11/12 lg:h-auto">
        <form id="home_mg_form_osc" action="/miami-quoter-finish" method="POST" class="mx-auto">
            @csrf
            <div class="lg:flex">
                ...
                <div class="border p-1 lg:p-2 lg:w-1/3">
                    ...
                    <span class="home_mg_osc_total">Total:$0.00</span>
                    <button id="home_mg_btn_osc" type="button" class="flex justify-center bg-global-600 rounded-lg
