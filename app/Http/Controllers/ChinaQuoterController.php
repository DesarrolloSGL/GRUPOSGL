...
class ChinaQuoterController extends Controller
{
    ...
    public function order(Request $request){
        ...
        $request->request->add(['order_number'=>'SGLCHI'.$random]);
        // Create new Order
    ...
    public function finish(Request $request){
        ...
        // $request->request->add(['type'=>$request->payment_cg]);
    ...
    public function total($idquotation,$currency,$osc){
        ...
        $transport = $_weight * $rates->cost_per_pound_china;
        ...
        return(['total'=>$total,'exchange'=>$exchange]);
    }
